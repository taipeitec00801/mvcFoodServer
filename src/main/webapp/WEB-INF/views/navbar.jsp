	...
	<div class="container-fluid navbarSize">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="home"> <img alt="Brand"
				src="images/Logo.png"> <span>食在好評</span>
			</a>
		...
		<div class="collapse navbar-collapse"
			...
			<div class="col-lg-4 searchBar">
				<div class="input-group">
					<input type="search" class="form-control mySearchReq"
						placeholder="Search..."> <span class="input-group-btn">
						<a href="search">
							<button class="btn btn-default mySearchBot" type="button">
					...
					<li><a href="member8877" class="fh5co-sub-ddown">會員</a>
						<ul class="fh5co-sub-menu" id="myMenu">
							<form class="myForm formOut">
								...
								<div class="myLabel">
									<label for="inputPassword">Password</label> <input
										type="password" class="form-control inputMargin inputPassword"
										name="inputPassword">
								</div>
							...
							<form class="myForm formIn" style="display: none">
								...
								<div class="submitDiv">
									<button type="button" class="btn btn-default myButton logOutBt"
										name="logOutBt">登出</button>
								</div>
								<div class="clearFloat"></div>
							</form>
						</ul>
