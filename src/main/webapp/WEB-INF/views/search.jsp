...
<title>Search &mdash; 100% Free Fully Responsive HTML5 Template
		...
		<div id="fh5co-page">
			...
			<div class="searchTitle">
				<div class="container">
					<div
						...
						<h1>搜尋&nbsp;&nbsp;"${searchReq}"&nbsp;&nbsp;Store</h1>
						<p>${nowTime}<br> 有 ${requestSize} 項結果
						</p>
					</div>
				</div>
			</div>
			...
			<div class="searchBackground">
				<div class="searchCard">
					<c:choose>
						<c:when test="${requestSize==0}">
							<div class="noReq">
								<a href=""> 
									<img src="images/image-add-button.png"><br>
									<span>尚無此店家</span>
								</a>
							</div>
						</c:when>
						<c:otherwise>
							...
							<div class="searchContent">
								<c:forEach var="store" begin="0" end="9" items="${stores}">
									<div class="col-sm-6 col-md-4 bottomPlace">
										<div class="thumbnail">
											<img src="<c:url value='/getPicture/${store.storeId}/0'/>"
												style="height: 270px" />
											<div class="caption">
												...
												<div class="captionBottom">
													<a
														...
														${store.storeCommentCount} <i class="icon-bubble2"
														style="color: #203a43;"></i>
													</span>
												</div>
											</div>
										</div>
							...
							<!-- pag -->
							<div class="pageBox">
								<span class="pages"> <nav aria-label="Page navigation">
									<ul class="pagination">
										<li><a href="<spring:url value='search?pages=1' />"
											aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
										</a></li>
										<c:forEach var="pagesNo" begin="1" end="${totalPages}">
											<li><a
												href="<spring:url value='search?pages=${pagesNo}' />"
												class="pagesNo_${pagesNo}">${pagesNo}</a></li>
										</c:forEach>
										<li><a
											href="<spring:url value='search?pages=${totalPages}' />"
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			if (strUrl.indexOf("?") != -1) {
				...
				/* ?pages=isPages */
				isPages = getPara[0].substring(getPara[0].indexOf("=") + 1);
			}
